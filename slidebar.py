...
# Slider properties
slider_x = 10  # X-coordinate of the slider
slider_width = 150
slider_height = 10
slider_button_width = 20
slider_button_height = 20
slider_min = 1  # Minimum speed value
slider_max = 10  # Maximum speed value
slider_value = 5  # Initial speed value
# Colors
BLACK = (0, 0, 0)
WHITE = (255, 255, 255)
GRAY = (200, 200, 200)
...
class handDetector():
    ...
    def findHands(self, img, draw=True):
        ...
        # print("Result : ",self.results.multi_hand_landmarks)
...
# ⚠️
while running and (clock.tick() - start_time) < 1000:
    global b1
    global b2
    global b3
    global b4
    ...
    if start < 0:
        ...
        show_player(1920 - clocX, clocY)
        # cv2.imshow("Image", img)
        # cv2.waitKey(1)

        player_rect = pygame.Rect(1920 - clocX, clocY, 10, 10)
