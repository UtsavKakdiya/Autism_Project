...
b_img_1 = 'red_1 1 (Custom) (2).png'
b_img_2 = 'red_2 1 (Custom) (1).png'
b_img_3 = 'red_3 1 (Custom) (1).png'
b_img_4 = 'red_4 1 (Custom) (1).png'
b_img_5 = 'red_5 1 (Custom) (1).png'
...
text_font1 = pygame.font.SysFont(None, 70)
...
def show_timer(text, font, text_col, size):
    ...
    screen.blit(timerImg, ((screen.get_width() - 250), 15))
...
def show_randInt(text, font, text_col):
    ...
    screen.blit(randIntImg, (int(screen.get_width() / 2), 15))
...
def get_cord():
    x = random.randint(0, (screen.get_width() - 180))
    y = random.randint(80, (screen.get_height() - 300))
    return x, y
...
while running:
    ...
    header_line = pygame.draw.line(screen, (0, 0, 0), (0, 80), (screen.get_width(), 80), 4)
    ...
    if start <= 1:
        ...
        replay_rect = replay_text.get_rect(center=(a_x / 2.95, a_y - 230))
        exit_rect = exit_text.get_rect(center=(2 * a_x / 2.95, a_y - 230))
        ...
        b1_rect = pygame.Rect(b1.balloonX, b1.balloonY, 180, 180)
        b2_rect = pygame.Rect(b2.balloonX, b2.balloonY, 180, 180)
        b3_rect = pygame.Rect(b3.balloonX, b3.balloonY, 180, 180)
        b4_rect = pygame.Rect(b4.balloonX, b4.balloonY, 180, 180)
        b5_rect = pygame.Rect(b5.balloonX, b5.balloonY, 180, 180)
        ...
        if flag == 1:
            choosenImg = b_choose()
            #audio_thread = threading.Thread(target=pop_audio())
            #audio_thread.start()
            #audio_thread.join()
            flag = 0

        show_score(10, 15, 50, (0, 0, 0))
        show_timer("Time : " + str(int(start / 100)), text_font, (0, 0, 0), 50)
